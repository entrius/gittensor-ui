      ...
      <Box sx={{ borderBottom: "1px solid rgba(255,255,255,0.1)", backgroundColor: "rgba(0,0,0,0.2)" }}>
        <Container maxWidth="xl">
          <Box sx={{ pt: 3, pb: 0 }}>
            ...
            <Grid container spacing={4} sx={{ mt: 1, mb: 3 }} alignItems="flex-start">
              <Grid item xs={12} md={8}>
                ...
                <Box sx={{
                  ...
                  {/* Compact version or just the table - standard table fits if container is wide enough, otherwise it will scroll */}
