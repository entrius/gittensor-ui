      ...
      >
        <Stack spacing={3}>
          ...
          <Box sx={{ minHeight: 400 }}>
            {tabIndex === 0 && (
              <IssuesList
                issues={Array.isArray(activeIssuesQuery.data) ? activeIssuesQuery.data : []}
            ...
            {tabIndex === 1 && (
              <IssuesList
                issues={Array.isArray(registeredIssuesQuery.data) ? registeredIssuesQuery.data : []}
            ...
            {tabIndex === 2 && (
              <IssuesList
                issues={Array.isArray(historyIssuesQuery.data) ? historyIssuesQuery.data : []}
