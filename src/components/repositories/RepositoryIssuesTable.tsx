        ...
        return (
            ...
            >
                <Box sx={{ display: "flex", justifyContent: "space-between", mb: 3 }}>
                    <Typography variant="h6" sx={{ color: "#fff", fontFamily: '"JetBrains Mono", monospace' }}>Issues</Typography>
                </Box>
        ...
        >
            ...
            >
                ...
                <Stack direction="row" spacing={1}>
                    <FilterButton label="All" value="all" count={counts.total} color="#8b949e" />
                    <FilterButton label="Open" value="open" count={counts.open} color="#3fb950" />
                    <FilterButton label="Closed" value="closed" count={counts.closed} color="#a371f7" />
                </Stack>
            </Box>
                                ...
                                {sortedIssues.map((issue, index) => {
                                    ...
                                    return (
                                        <TableRow
                                            ...
                                            onClick={() => {
                                                window.open(`https://github.com/${issue.repositoryFullName}/issues/${issue.issueNumber}`, "_blank");
                                            }}
                                        >
                                            ...
                                            <TableCell sx={bodyCellStyle}>
                                                <Chip
                                                    icon={isOpen ? <RadioButtonUncheckedIcon sx={{ fontSize: 14 }} /> : <CheckCircleIcon sx={{ fontSize: 14 }} />}
