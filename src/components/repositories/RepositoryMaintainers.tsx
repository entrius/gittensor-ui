...
import { Box, Typography, Avatar, Tooltip, Link, Skeleton } from "@mui/material";
...
const RepositoryMaintainers: React.FC<RepositoryMaintainersProps> = ({
    ...
    const { data: maintainers, isLoading } = useRepositoryMaintainers(
        repositoryFullName
    );
    ...
    return (
        <Box sx={{ mb: 4 }}>
            ...
            >
                Maintainers{" "}
                <Typography component="span" sx={{ color: "#8b949e", fontSize: "0.8em" }}>
                    ({maintainers.length})
                </Typography>
            </Typography>
