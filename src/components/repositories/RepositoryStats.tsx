        ...
        <Box sx={{ mb: 4 }}>
            ...
            <Box sx={{ display: "flex", flexDirection: "column", gap: 1.5 }}>
                ...
                <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                    <Typography variant="body2" sx={{ fontSize: "13px", color: "#8b949e" }}>Weight</Typography>
                    <Typography
                        variant="body2"
                        sx={{
                            color: "#fff",
                ...
                {/* Tier */}
                <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                    <Typography variant="body2" sx={{ fontSize: "13px", color: "#8b949e" }}>Tier</Typography>
                    <Typography
                        variant="body2"
                        sx={{
                ...
                {/* Total Score */}
                <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                    <Typography variant="body2" sx={{ fontSize: "13px", color: "#8b949e" }}>Total Score</Typography>
                    <Typography
                        variant="body2"
                        sx={{
                            color: "#fff",
                    ...
                    >
                        {stats.totalScore.toLocaleString(undefined, { maximumFractionDigits: 0 })}
                    </Typography>
                </Box>

                {/* Merged PRs */}
                <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                    <Typography variant="body2" sx={{ fontSize: "13px", color: "#8b949e" }}>Merged PRs</Typography>
                    <Typography
                        variant="body2"
                        sx={{
                            color: "#fff",
