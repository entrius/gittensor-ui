  ...
  return (
    <Box sx={{ maxWidth: 900, mx: "auto", p: { xs: 2, md: 0 } }}>
      ...
      <Typography variant="body1" sx={{ mb: 4, lineHeight: 1.7 }}>
        Running a miner requires deployment on a server with reliable,
        continuous availability. Validators regularly query miners to verify
        their GitHub PAT, and miners must remain responsive to these requests.
      </Typography>
      ...
      <Stack spacing={4}>
        ...
        >
          ...
          <Typography variant="body1" sx={{ mb: 2 }}>
            Ensure that you have an accessible coldkey and hotkey. Please refer
            to the
            <Link
        ...
        >
          ...
          <CodeBlock
            code={`btcli subnet register --netuid 422 \\
...
--network test`}
          ...
          <Typography
            variant="subtitle2"
            sx={{ color: "text.secondary", mb: 1, mt: 3 }}
          >
            Mainnet (Netuid 74)
          </Typography>
          <CodeBlock
            code={`btcli subnet register --netuid 74 \\
--wallet-name WALLET_NAME \\
--hotkey WALLET_HOTKEY`}
          />
        </Paper>
        ...
        >
          ...
          <Typography variant="body1" component="div" sx={{ mb: 2 }}>
            <ol style={{ paddingLeft: "1.2rem", lineHeight: "1.8" }}>
              <li>
                In Github go to your <strong>Settings</strong> →{" "}
                <strong>Developer settings</strong>.
              </li>
              <li>
                Go to <strong>Personal access tokens</strong> →{" "}
              ...
              <li>
                Token name: <code>gittensor</code>
              </li>
              <li>
                Expiration: <strong>No Expiration</strong> (recommended)
              </li>
              <li>
                Repository access: <strong>Public repositories</strong>{" "}
                (read-only)
              </li>
              <li>
                Permissions: <strong>Events</strong> → Access:{" "}
          ...
          >
            Some Github organizations forbid access via fine-grained PAT if the
            token's lifetime is indefinite.
          </Alert>
        </Paper>
        ...
        >
          ...
          <Typography variant="body1" sx={{ mb: 3 }}>
            Use the Autoupdater Setup (Recommended) to ensure your miner stays
            up to date.
          </Typography>
          ...
          <CodeBlock
            code={`git clone git@github.com:entrius/gittensor.git
cd gittensor
...
git checkout main`}
          ...
          <CodeBlock
            code={`cp gittensor/miner/.env.example gittensor/miner/.env
...
sed -i \\
  ...
  gittensor/miner/.env`}
          ...
          <CodeBlock
            code={`sudo chmod +x scripts/*
./scripts/setup_env.sh`}
          />

          <Typography variant="h6" sx={{ mb: 1, fontWeight: "bold", mt: 3 }}>
            C. Run miner & Autoupdater
          </Typography>
          <Typography variant="body2" sx={{ mb: 1 }}>
...
./scripts/run_autoupdater.sh --processes miner --check-interval 900`}
        ...
        >
          ...
          <Typography variant="body1" sx={{ mb: 2 }}>
            For Gittensor to track your contributions and reward you, every Pull
            Request MUST include the following tagline at the end of the PR
            description (last 150 characters).
          </Typography>
          ...
          >
            Without this tag, your contributions will NOT be tracked and you
            will receive NO rewards.
          </Alert>
          ...
          <Typography variant="body2" color="text.secondary">
            Replace <code>{`{github_id}`}</code> with your actual GitHub
            username.
          </Typography>
        </Paper>
