...
const PerformanceRadar: React.FC<PerformanceRadarProps> = ({
    ...
    series: [
      {
        ...
        data: [
          {
            value: [credibility, complexity, issuesSolved, uniqueRepos, totalPRs, avgRepoWeight],
            name: "Miner Stats",
            symbol: "circle",
            symbolSize: 4,
  ...
  }), [credibility, complexity, issuesSolved, uniqueRepos, totalPRs, avgRepoWeight]);

  return (
    <Box sx={{ display: "flex", flexDirection: "column", justifyContent: "center" }}>
      <Typography variant="monoSmall" sx={{ color: "rgba(255, 255, 255, 0.4)", mb: 2, textAlign: "center" }}>
        Performance Profile
      </Typography>
